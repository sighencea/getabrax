                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                    <button className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-lg">
                      <svg
                        ...
                        className="lucide lucide-play w-8 h-8 text-gray-900 ml-1"
                      >
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="bg-white bg-opacity-90 rounded-lg p-4">
                      <h3 className="font-semibold text-gray-900 mb-1">See How It Works</h3>
                    ...
                    <div className="flex-1">
                      ...
                      <blockquote className="text-gray-700 mb-4 relative">
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-quote w-6 h-6 text-blue-200 absolute -top-2 -left-2"
                        >
                          <path d="M16 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path>
                          <path d="M5 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z"></path>
                        </svg>
                        <p className="relative z-10 italic">
                          This platform has revolutionized how we handle maintenance. We've cut our
                          response time by 60% and our tenants are happier than ever.
                        </p>
                      </blockquote>
                      <div>
                        <div className="font-semibold text-gray-900">Sarah Johnson</div>
                        <div className="text-sm text-gray-600">
                          Property Manager at Metro Properties
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <blockquote className="text-gray-700 mb-4 relative">
                        ...
                        <p className="relative z-10 italic">
                          The cost savings have been incredible. We've reduced our maintenance budget
                          by 40% while actually improving service quality.
                        </p>
                      </blockquote>
                      <div>
                        <div className="font-semibold text-gray-900">Michael Chen</div>
                        <div className="text-sm text-gray-600">
                          Operations Director at Urban Living Group
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <blockquote className="text-gray-700 mb-4 relative">
                        ...
                        <p className="relative z-10 italic">
                          The mobile app is a game-changer. I can manage work orders from anywhere
                          and keep track of all our properties in real-time.
                        </p>
                      </blockquote>
                      <div>
                        <div className="font-semibold text-gray-900">Lisa Rodriguez</div>
                        <div className="text-sm text-gray-600">
                          Portfolio Manager at Residential Plus
                        </div>
                      </div>
                    </div>
                  </div>
