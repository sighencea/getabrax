...
import { User, Mail, Briefcase, MessageSquare, Send } from 'lucide-react';
...
export const CareersPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(t('pages.careers.successMessage'));
  };
